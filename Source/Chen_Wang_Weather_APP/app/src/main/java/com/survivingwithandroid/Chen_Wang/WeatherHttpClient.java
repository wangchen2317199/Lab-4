...
public class WeatherHttpClient {
	...
	public String getWeatherData(String location, String lang) {
		...
		try {
			String url = BASE_URL + location + "&APPID=15be36445a2ae01a56daef040c36b9f3";
			if (lang != null)
				url = url + "&lang=" + lang;
	...
	public String getForecastWeatherData(String location, String lang, String sForecastDayNum) {
		...
		try {
			...
			url = url + "&APPID=15be36445a2ae01a56daef040c36b9f3";
			con = (HttpURLConnection) ( new URL(url)).openConnection();
			con.setRequestMethod("GET");
			con.setDoInput(true);
			con.setDoOutput(true);
	...
	public byte[] getImage(String code) {
		...
		InputStream is = null;
		try {
			con = (HttpURLConnection) ( new URL(IMG_URL + code + "&APPID=15be36445a2ae01a56daef040c36b9f3")).openConnection();
			con.setRequestMethod("GET");
			con.setDoInput(true);
			con.setDoOutput(true);
			con.connect();
